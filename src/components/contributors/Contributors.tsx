...
const Contributors = ({ total, show }: Props) => {
  ...
  return (
    <div
      ...
      className="relative p-2 lg:px-16 xl:px-20 2xl:px-72 flex justify-start items-center border-b-2 dark:border-green-500 border-green-400 dark:bg-dark-300 bg-white dark:text-white text-dark-300"
      style={{ minHeight: 40 }}
    >
