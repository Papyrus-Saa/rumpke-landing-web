...
const TextMessageBox = ({ onSend }: TextMessageBoxProps) => {
  ...
  return (
    <form
      ...
      className="flex flex-row items-center h-12 pb-5 rounded duration-100  w-full">
      ...
      <div className="grow">
        ...
        <div className="relative w-full">
          ...
          <input type="text" inputMode="text"
            ...
            autoFocus
            name="message"
            className="flex w-full border rounded dark:text-light-100 text-dark-300 focus:outline-none focus:ring-2 focus:ring-mint-600 focus:border-transparent pl-4 pr-12 h-10"
