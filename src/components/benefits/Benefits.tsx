    ...
    <div className="w-full sm:w-[90%] mx-auto transition-all duration-100">
      <section className="w-full max-w-3xl mx-auto px-4 py-8 shadow bg-light-100 dark:bg-dark-200 transition-all duration-100">
        <div className="text-center mb-8 transition-all duration-100">
          ...
          <h3 className="text-3xl sm:text-4xl font-bold text-mint-600 dark:text-mint-300 mb-2 drop-shadow transition-all duration-100">
        ...
        <div className="space-y-4 transition-all duration-100">
          {BENEFITS.map((b, i) => (
            <div
              key={i}
              className="flex flex-col sm:flex-row items-start sm:items-center justify-between px-5 py-4 shadow-[var(--shadow-subtle-l)] dark:shadow-[var(--shadow-subtle-d)] hover:scale-[1.02] transition-all duration-100"
            >
              <div className="flex-shrink-0 w-full sm:w-48 mb-2 sm:mb-0 transition-all duration-100">
                <span className="block text-lg sm:text-xl font-bold text-mint-600 transition-all duration-100">
                  {b.amount}
                </span>
                <span className="block text-base font-semibold text-gray-700 dark:text-gray-200 transition-all duration-100">
                  {b.title}
                </span>
              </div>
              <div className="text-gray-600 dark:text-gray-300 text-sm sm:text-base sm:pl-6 transition-all duration-100">
                {b.desc}
              </div>
            </div>
          ))}
