...
const ScrollToFormButton: React.FC = () => {
  ...
  return (
    <button
      ...
      className="fixed right-2 2xl:right-42 top-1/2 -translate-y-1/2 z-10 w-6 h-6 flex items-center justify-center overflow-visible shadow-[var(--shadow-subtle-l)] dark:shadow-[var(--shadow-subtle-d)] hover:shadow-[var(--shadow-subtle-l)] dark:hover:shadow-[var(--shadow-subtle-d)] transition-shadow rainbow-border-animated bg-mint-600 cursor-pointer"
      onClick={() => {
