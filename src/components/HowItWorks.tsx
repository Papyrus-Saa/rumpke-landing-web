...
const HowItWorks = () => {
  return (
    <div className='dark:bg-dark-200 bg-light-100 w-full xl:w-[80%] 2xl:w-[70%] p-4 mb-6 mx-auto shadow border dark:border-dark-100 rounded-lg border-light-200'>
      ...
      <div className='relative bg-white dark:bg-dark-300 p-4 lg:flex justify-center items-center'>
        ...
        <div className="w-full lg:w-1/2 flex justify-center items-center">
          <Image
            ...
            width={360}
            height={320}
            className="rounded shadow w-full max-w-[360px] max-h-[320px] h-auto"
