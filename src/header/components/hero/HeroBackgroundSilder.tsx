        ...
        {imgs.map((item) => (
          <SwiperSlide key={item.id}>
            <div className="relative w-full h-[50vh] lg:h-[70vh] flex items-center justify-center overflow-hidden">
              ...
              <div className="2xl:px-30 absolute left-0 top-1/5 xl:top-1/2  -translate-y-1/2 pl-6 sm:pl-12 max-w-[90vw] sm:max-w-[60vw] flex items-center pointer-events-none select-none">
