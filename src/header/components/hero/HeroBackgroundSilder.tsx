          ...
          <SwiperSlide key={item.id}>
            <div className="relative w-full h-[50vh] lg:h-[60vh] flex items-center justify-center">
              <Image
                ...
                priority={item.id === 1}
              />
              {/* Welcome: centro izquierda */}
              <div className="2xl:px-50 absolute left-0 top-1/5 xl:top-1/2  -translate-y-1/2 pl-6 sm:pl-12 max-w-[90vw] sm:max-w-[60vw] flex items-center pointer-events-none select-none">
              ...
              {/* Quote: abajo derecha */}
              <div className="absolute right-0 2xl:px-50 bottom-0 pb-8 pr-6 sm:pb-16 sm:pr-12 max-w-[90vw] sm:max-w-[60vw] flex justify-end pointer-events-none select-none">
